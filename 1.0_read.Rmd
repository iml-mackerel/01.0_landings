...
```{r ZIFF_npbc}
kable(cbind(with(ziff[ziff$npbc %in% c('000000', 'B00000', '190000'),], table(year,npbc)),
            total=with(ziff, tapply(npbc, year, length))))  
```
...
```
### CHECK {.tabset}
Nafo B is used for landings prior 1995.
